...
namespace webrtc {
  ...
  bool VHAudioDeviceWindowsCore::CoreAudioIsSupported() {
    ...
    if (MMDeviceIsAvailable) {
      ...
      VHAudioDeviceWindowsCore* p = new VHAudioDeviceWindowsCore();
      if (p == NULL) {
        return false;
      }
  ...
  void VHAudioDeviceWindowsCore::PushAudioSegment(float * buffer, unsigned int numFrames, unsigned long long timestamp)
  {
    std::shared_ptr<float[]> data(new float[2 * 441]);
    if (nullptr == data) {
      return;
    }
    memset(data.get(), 0, 2 * 441 * sizeof(float));
    memcpy(data.get(), buffer, sizeof(float) * 2 * 441);
    std::shared_ptr<vhall::AudioCaptureMix> mix = mMix;
    if (mix) {
      /* 调节音量 */
      if (1.0 != mMicroPhoneVolume) {
        //MultiplyAudioBuffer(data.get(), 44100 / 100 * 2, mMicroPhoneVolume); //todo
      }

      std::chrono::time_point<std::chrono::steady_clock> ts = std::chrono::steady_clock::now();
      int64_t curTime = std::chrono::duration_cast<std::chrono::microseconds>(ts.time_since_epoch()).count();
      std::shared_ptr<vhall::AudioCaptureMix::AudioData> mixData(new vhall::AudioCaptureMix::AudioData(data, 44100, 2, curTime / 1000));
      if (mixData) {
        mix->PushDshow(mixData);
      }
    }
  }
  ...
  // ----------------------------------------------------------------------------
  //  VHAudioDeviceWindowsCore() - ctor
  // ----------------------------------------------------------------------------

  VHAudioDeviceWindowsCore::VHAudioDeviceWindowsCore()
    : _avrtLibrary(NULL),
    ...
    mMicroPhoneVolume(1) 
  {
    //f_pcm = webrtc::FileWrapper::OpenWriteOnly("./test.pcm");
    RTC_LOG(LS_INFO) << __FUNCTION__ << " created";
    assert(_comInit.succeeded());
    m_pDeviceObtain.reset(new(std::nothrow) CDeviceObtain());
    mDShowCapture = std::make_shared<vhall::DShowAudioCapture>();
    ...
    mDeviceNotify = new vhall::AudioDeviceNotify(_ptrEnumerator);
    assert(NULL != mDeviceNotify);
    assert(mDeviceNotify->Init());
    _ptrEnumerator->RegisterEndpointNotificationCallback(mDeviceNotify);
  ...
  VHAudioDeviceWindowsCore::~VHAudioDeviceWindowsCore() {
    ...
    if (_ptrEnumerator && mDeviceNotify) {
      _ptrEnumerator->UnregisterEndpointNotificationCallback(mDeviceNotify);
    }
    SAFE_RELEASE(_ptrEnumerator);
    SAFE_RELEASE(mDeviceNotify);
  ...
  void VHAudioDeviceWindowsCore::AttachAudioBuffer(AudioDeviceBuffer* audioBuffer) {
    _ptrAudioBuffer = audioBuffer;

    // Inform the AudioBuffer about default settings for this implementation.
    // Set all values to zero here since the actual settings will be done by
    // InitPlayout and InitRecording later.
    _ptrAudioBuffer->SetRecordingSampleRate(mixed_audio_sample_rate);
    _ptrAudioBuffer->SetPlayoutSampleRate(0);
    _ptrAudioBuffer->SetRecordingChannels(mixed_audio_channel);
  ...
  int32_t VHAudioDeviceWindowsCore::ActiveAudioLayer(
  ...
  AudioDeviceGeneric::InitStatus VHAudioDeviceWindowsCore::Init() {
  ...
  int32_t VHAudioDeviceWindowsCore::Terminate() {
    rtc::CritScope lock(&_critSect);
  ...
  bool VHAudioDeviceWindowsCore::Initialized() const {
    return (_initialized);
  }
  ...
  int32_t VHAudioDeviceWindowsCore::InitSpeaker() {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::InitMicrophone() {
    rtc::CritScope lock(&_critSect);
  ...
  bool VHAudioDeviceWindowsCore::SpeakerIsInitialized() const {
  ...
  bool VHAudioDeviceWindowsCore::MicrophoneIsInitialized() const {
  ...
  int32_t VHAudioDeviceWindowsCore::SpeakerVolumeIsAvailable(bool& available) {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::SetSpeakerVolume(uint32_t volume) {
    {
      rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::SpeakerVolume(uint32_t& volume) const {
    {
      rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::MaxSpeakerVolume(uint32_t& maxVolume) const {
    if (!_speakerIsInitialized) {
      return -1;
    }
  ...
  int32_t VHAudioDeviceWindowsCore::MinSpeakerVolume(uint32_t& minVolume) const {
    if (!_speakerIsInitialized) {
      return -1;
    }
  ...
  int32_t VHAudioDeviceWindowsCore::SpeakerMuteIsAvailable(bool& available) {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::SetSpeakerMute(bool enable) {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::SpeakerMute(bool& enabled) const {
    if (!_speakerIsInitialized) {
      return -1;
    }
  ...
  int32_t VHAudioDeviceWindowsCore::MicrophoneMuteIsAvailable(bool& available) {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::SetMicrophoneMute(bool enable) {
  ...
  int32_t VHAudioDeviceWindowsCore::MicrophoneMute(bool& enabled) const {
    if (!_microphoneIsInitialized) {
      return -1;
    }
  ...
  int32_t VHAudioDeviceWindowsCore::StereoRecordingIsAvailable(bool& available) {
    available = true;
    return 0;
  }
  ...
  int32_t VHAudioDeviceWindowsCore::SetStereoRecording(bool enable) {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::StereoRecording(bool& enabled) const {
    if (_recChannels == 2)
      enabled = true;
    else
      enabled = false;
  ...
  int32_t VHAudioDeviceWindowsCore::StereoPlayoutIsAvailable(bool& available) {
    available = true;
    return 0;
  }
  ...
  int32_t VHAudioDeviceWindowsCore::SetStereoPlayout(bool enable) {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::StereoPlayout(bool& enabled) const {
    if (_playChannels == 2)
      enabled = true;
    else
      enabled = false;
  ...
  int32_t VHAudioDeviceWindowsCore::MicrophoneVolumeIsAvailable(bool& available) {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::SetMicrophoneVolume(uint32_t volume) {
    RTC_LOG(LS_VERBOSE) << "AudioDeviceWindowsCore::SetMicrophoneVolume(volume="
      << volume << ")";

    mMicroPhoneVolume = static_cast<float>(volume / 100.0f);
    return 0;
  //  {
  //    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::MicrophoneVolume(uint32_t& volume) const {
    {
      rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::MaxMicrophoneVolume(uint32_t& maxVolume) const {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::MinMicrophoneVolume(uint32_t& minVolume) const {
    if (!_microphoneIsInitialized) {
      return -1;
    }
  ...
  int16_t VHAudioDeviceWindowsCore::PlayoutDevices() {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::SetPlayoutDevice(uint16_t index) {
  ...
  int32_t VHAudioDeviceWindowsCore::SetPlayoutDevice(
  ...
  int32_t VHAudioDeviceWindowsCore::PlayoutDeviceName(
    uint16_t index,
  ...
  int32_t VHAudioDeviceWindowsCore::RecordingDeviceName(
    uint16_t index,
    char name[kAdmMaxDeviceNameSize],
    char guid[kAdmMaxGuidSize]) {
    bool defaultCommunicationDevice(false);
  ...
  int16_t VHAudioDeviceWindowsCore::RecordingDevices() {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::SetRecordingDevice(uint16_t index) {
  ...
  int32_t VHAudioDeviceWindowsCore::SetRecordingDevice(
    AudioDeviceModule::WindowsDeviceType device) {
    if (_recIsInitialized) {
      return -1;
    }
  ...
  int32_t VHAudioDeviceWindowsCore::SetRecordingDevice(std::string device) {
    SetAudioLayer(webrtc::AudioDeviceModule::AudioLayer::kWindowsDshowAudio);
    _recIsInitialized = true;
    mDshowDevice = device;
    return int32_t(0);
  }

  void VHAudioDeviceWindowsCore::SetAudioLayer(webrtc::AudioDeviceModule::AudioLayer audio_layer) {
    if (mAudioLayer != audio_layer) {
      /* Stop capture before switch capture mode */
      StopRecording();
      mAudioLayer = audio_layer;
    }
  }
  ...
  int32_t VHAudioDeviceWindowsCore::PlayoutIsAvailable(bool& available) {
    available = false;
  ...
  int32_t VHAudioDeviceWindowsCore::RecordingIsAvailable(bool& available) {
    available = false;
  ...
  int32_t VHAudioDeviceWindowsCore::InitPlayout() {
    rtc::CritScope lock(&_critSect);
  ...
  int32_t VHAudioDeviceWindowsCore::InitRecordingDMO() {
  ...
  int32_t VHAudioDeviceWindowsCore::InitRecording() {
    if (mAudioLayer != webrtc::AudioDeviceModule::AudioLayer::kWindowsCoreAudio) {
      /* using DShow capture does not init here */
      if (_ptrAudioBuffer) {
        // Update the audio buffer with the selected parameters
        if (mDShowCapture) {
          std::shared_ptr<vhall::AudioConfig> audioConfig = mDShowCapture->GetAudioConfig();
          if (audioConfig) {
            _ptrAudioBuffer->SetRecordingSampleRate(mixed_audio_sample_rate);
            _ptrAudioBuffer->SetRecordingChannels(mixed_audio_channel);
            _recIsInitialized = true;
    ...
    if (pWfxIn->wFormatTag == WAVE_FORMAT_EXTENSIBLE) {
      WAVEFORMATEXTENSIBLE *wfext = (WAVEFORMATEXTENSIBLE*)pWfxIn;
      _inputChannelMask = wfext->dwChannelMask;

      if (wfext->SubFormat != KSDATAFORMAT_SUBTYPE_IEEE_FLOAT) {
        LOGE("CoreAudioSource::Initialize(): Unsupported wave format");
        EXIT_ON_ERROR(-1);
      }
    ...
    } else if (pWfxIn->wFormatTag != WAVE_FORMAT_IEEE_FLOAT) {
      LOGE("CoreAudioSource::Initialize(%d): Unsupported wave format");
      EXIT_ON_ERROR(-1);
    }

    _recAudioFrameSize = pWfxIn->nBlockAlign;
    _recSampleRate = pWfxIn->nSamplesPerSec;
    _recBlockSize = pWfxIn->nSamplesPerSec / 100;
    _recChannels = pWfxIn->nChannels;
    _recBitsPerSample = pWfxIn->wBitsPerSample;
    ...
    hr = _ptrClientIn->Initialize(
      ...
      5 * 10000000,                    // required for event-driven shared mode
      0,                    // periodicity
      pWfxIn,               // selected wave format
      NULL);                // session GUID

    if (hr != S_OK) {
      std::stringstream err_info;
      err_info << "IAudioClient::Initialize() failed, hr:" << hr;
      RTC_LOG(LS_ERROR) << err_info.str();
      LOGE("%s", err_info.str().c_str());
      if (mDeviceNotify) {
        mDeviceNotify->CoreAudioError(IAUDIOCLIENT_INITIALIZE, hr, err_info.str());
      }
    }
    EXIT_ON_ERROR(hr);
  ...
  int32_t VHAudioDeviceWindowsCore::StartRecording() {
    if (!_recIsInitialized) {
      return -1;
    }

    if (mAudioLayer != webrtc::AudioDeviceModule::AudioLayer::kWindowsDshowAudio && _hRecThread != NULL) {
      /* if core audio mode && thread not initilized */
      return 0;
    }
    ...
    if (mAudioLayer != webrtc::AudioDeviceModule::AudioLayer::kWindowsDshowAudio) {
      {
      ...
      {
        /* Flush Dshow device */
        DeviceList mDShowMicList;
        mDShowMicList.clear();
        if (m_pDeviceObtain) {
          m_pDeviceObtain->GetAudioDevices(mDShowMicList, eCapture);
        }
        /* find dev and set device info */
        auto itor = mDShowMicList.begin();
        for (; itor != mDShowMicList.end(); itor++) {
          /* only get dshow device */
          if (itor->m_sDeviceType != TYPE_COREAUDIO) {
            char guid[128] = { 0 };
            int nLen = WideCharToMultiByte(CP_UTF8, 0, itor->m_sDeviceName, -1, NULL, 0, NULL, NULL);
            if (nLen >= 0) {
              WideCharToMultiByte(CP_UTF8, 0, itor->m_sDeviceName, -1, guid, nLen, NULL, NULL);
            }
            if (!mDshowDevice.compare(guid) && mDShowCapture) {
              /* Set capture parameters */
              bool ret = mDShowCapture->SetMicDeviceInfo(*itor, false, -96, -90, 44100, mDeviceNotify);
              if (!ret) {
                RTC_LOG(LS_VERBOSE) << "DShow audio capture SetMicDeviceInfo failed";
              }
              //_recIsInitialized = true;
            }
          }
      ...
      /* Start Dshow capture */
      if (mDShowCapture) {
        mDShowCapture->SetAudioListening(this);
        bool ret = mDShowCapture->Start();
        if (!ret) {
          RTC_LOG(LS_VERBOSE) << "DShow capture start failed";
          _recording = false;
          return false;
        }
      }
    ...
    /* Init audio Mix */
    std::shared_ptr<vhall::AudioCaptureMix> mix = std::make_shared<vhall::AudioCaptureMix>();
    if (mix) {
      webrtc::AudioDeviceBuffer* AudioBuffer = _ptrAudioBuffer;
      mix->Start([&, AudioBuffer](std::shared_ptr<short[]>& data, int sampleRate, int channel, int recDelay)->void {
        /*if (1.0 != mMicroPhoneVolume) {
          int16_t* frame_data = data.get();
          for (size_t i = 0; i < sampleRate * channel / 100; i++) {
            frame_data[i] = static_cast<int16_t>(mMicroPhoneVolume * frame_data[i]);
          }
        }*/
        /* deliver */
        ...
        AudioBuffer->DeliverRecordedData();

        /* export pcm data */
        if (audio_observer) {
          const size_t frames = sampleRate / 100;
          const size_t bytes_per_frame = channel * sizeof(int16_t);
          uint32_t new_mic_level_dummy = 0;
          uint32_t total_delay_ms = 0;
          audio_observer->RecordedDataIsAvailable(
            (void*)data.get(), frames, bytes_per_frame, channel,
            sampleRate, total_delay_ms, 0, 0, true,
            new_mic_level_dummy);
        }
        });
    }
  ...
  int32_t VHAudioDeviceWindowsCore::StopRecording() {
    int32_t err = 0;
    ...
    _Lock();
    if (mAudioLayer != webrtc::AudioDeviceModule::AudioLayer::kWindowsDshowAudio) { /* core audio */
      if (_hRecThread == NULL) {
        RTC_LOG(LS_VERBOSE)
  ...
  bool VHAudioDeviceWindowsCore::RecordingIsInitialized() const {
  ...
  bool VHAudioDeviceWindowsCore::Recording() const {
    return (_recording);
  }
  ...
  bool VHAudioDeviceWindowsCore::PlayoutIsInitialized() const {
  ...
  int32_t VHAudioDeviceWindowsCore::StartPlayout() {
    if (!_playIsInitialized) {
      return -1;
    }
  ...
  int32_t VHAudioDeviceWindowsCore::StopPlayout() {
    if (!_playIsInitialized) {
      return 0;
    }
  ...
  int32_t VHAudioDeviceWindowsCore::PlayoutDelay(uint16_t& delayMS) const {
    rtc::CritScope critScoped(&_critSect);
    delayMS = static_cast<uint16_t>(_sndCardPlayDelay);
    return 0;
  }

  bool VHAudioDeviceWindowsCore::BuiltInAECIsAvailable() const {
    return _dmo != nullptr;
  }
  ...
  bool VHAudioDeviceWindowsCore::Playing() const {
    return (_playing);
  }
  ...
  DWORD WINAPI VHAudioDeviceWindowsCore::WSAPIRenderThread(LPVOID context) {
    return reinterpret_cast<VHAudioDeviceWindowsCore*>(context)->DoRenderThread();
  }
  ...
  DWORD WINAPI VHAudioDeviceWindowsCore::WSAPICaptureThread(LPVOID context) {
    return reinterpret_cast<VHAudioDeviceWindowsCore*>(context)->DoCaptureThread();
  }

  DWORD WINAPI VHAudioDeviceWindowsCore::WSAPICaptureThreadPollDMO(LPVOID context) {
    return reinterpret_cast<VHAudioDeviceWindowsCore*>(context)
  ...
  DWORD VHAudioDeviceWindowsCore::DoRenderThread() {
  ...
  DWORD VHAudioDeviceWindowsCore::InitCaptureThreadPriority() {
    _hMmTask = NULL;
  ...
  void VHAudioDeviceWindowsCore::RevertCaptureThreadPriority() {
    if (_winSupportAvrt) {
      if (NULL != _hMmTask) {
  ...
  DWORD VHAudioDeviceWindowsCore::DoCaptureThreadPollDMO() {
  ...
  DWORD VHAudioDeviceWindowsCore::DoCaptureThread() {
    bool keepRecording = true;
    ...
    while (keepRecording) {
      ...
      DWORD waitResult = WaitForMultipleObjects(2, waitArray, FALSE, 1000);
      switch (waitResult) {
        ...
        if (SUCCEEDED(hr)) {
          ...
          while (syncBufIndex >= _recBlockSize) {
            ...
            if (_ptrAudioBuffer) {
              ...
              if (mix) {
                /* 调节麦克风音量 */
                if (mMicroPhoneVolume < 0.99f) {
                  MultiplyAudioBuffer(FinalData.get(), 44100 / 100 * 2, mMicroPhoneVolume);
                }

                std::chrono::time_point<std::chrono::steady_clock> ts = std::chrono::steady_clock::now();
                int64_t curTime = std::chrono::duration_cast<std::chrono::microseconds>(ts.time_since_epoch()).count();
                std::shared_ptr<vhall::AudioCaptureMix::AudioData> mixData(new vhall::AudioCaptureMix::AudioData(FinalData, 44100, 2, curTime / 1000));
                if (mixData) {
                  mix->PushCoreAudio(mixData);
                }
              }
  ...
  Exit:
    if (FAILED(hr)) {
      _ptrClientIn->Stop();
      _UnLock();
      std::string error_info = _TraceCOMError(hr);
      if (mDeviceNotify) {
        mDeviceNotify->CoreAudioError(COREAUDIOCAPTUREERROR, hr, error_info);
      }
    }
  ...
  void VHAudioDeviceWindowsCore::QuadToStereo(const int16_t * src_audio, size_t samples_per_channel, int16_t * dst_audio) {
  ...
  int32_t VHAudioDeviceWindowsCore::EnableBuiltInAEC(bool enable) {
    if (_recIsInitialized) {
      RTC_LOG(LS_ERROR)
  ...
  void VHAudioDeviceWindowsCore::_Lock() RTC_NO_THREAD_SAFETY_ANALYSIS {
    _critSect.Enter();
  }

  void VHAudioDeviceWindowsCore::_UnLock() RTC_NO_THREAD_SAFETY_ANALYSIS {
    _critSect.Leave();
  }

  int VHAudioDeviceWindowsCore::SetDMOProperties() {
    HRESULT hr = S_OK;
    assert(_dmo != NULL);
  ...
  int VHAudioDeviceWindowsCore::SetBoolProperty(IPropertyStore* ptrPS,
    REFPROPERTYKEY key,
    VARIANT_BOOL value) {
    PROPVARIANT pv;
    PropVariantInit(&pv);
  ...
  int VHAudioDeviceWindowsCore::SetVtI4Property(IPropertyStore* ptrPS,
    REFPROPERTYKEY key,
    LONG value) {
    PROPVARIANT pv;
    PropVariantInit(&pv);
  ...
  int32_t VHAudioDeviceWindowsCore::_RefreshDeviceList(EDataFlow dir) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int16_t VHAudioDeviceWindowsCore::_DeviceListCount(EDataFlow dir) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::_GetListDeviceName(EDataFlow dir,
    int index,
    LPWSTR szBuffer,
    int bufferLen) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::_GetDefaultDeviceName(EDataFlow dir,
    ERole role,
    LPWSTR szBuffer,
    int bufferLen) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::_GetListDeviceID(EDataFlow dir,
    int index,
    LPWSTR szBuffer,
    int bufferLen) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::_GetDefaultDeviceID(EDataFlow dir,
    ERole role,
    LPWSTR szBuffer,
    int bufferLen) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::_GetDefaultDeviceIndex(EDataFlow dir,
    ERole role,
    int* index) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::_GetDeviceName(IMMDevice* pDevice,
    LPWSTR pszBuffer,
    int bufferLen) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::_GetDeviceID(IMMDevice* pDevice,
    LPWSTR pszBuffer,
    int bufferLen) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::_GetDefaultDevice(EDataFlow dir,
    ERole role,
    IMMDevice** ppDevice) {
    RTC_LOG(LS_VERBOSE) << __FUNCTION__;
  ...
  int32_t VHAudioDeviceWindowsCore::_GetListDevice(EDataFlow dir,
    int index,
    IMMDevice** ppDevice) {
    HRESULT hr(S_OK);
  ...
  int32_t VHAudioDeviceWindowsCore::_EnumerateEndpointDevicesAll(
  ...
  std::string VHAudioDeviceWindowsCore::_TraceCOMError(HRESULT hr) const {
    wchar_t buf[MAXERRORLENGTH];
    wchar_t errorText[MAXERRORLENGTH];
    ...
    std::stringstream err_info;
    err_info << "Core Audio method failed (hr=" << hr << ")\n";
    StringCchPrintfW(buf, MAXERRORLENGTH, L"Error details: ");
    StringCchCatW(buf, MAXERRORLENGTH, errorText);
    err_info << rtc::ToUtf8(buf);
    LOGE("%s", err_info.str().c_str());
    RTC_LOG(LS_ERROR) << err_info.str();
    return err_info.str();
  }

  bool VHAudioDeviceWindowsCore::KeyPressed() const {
    int key_down = 0;
  ...
  int32_t webrtc::VHAudioDeviceWindowsCore::StartLoopBack(std::wstring device, uint32_t volume) {
    mLoopBack.reset(new vhall::AudioLoopBackRecording());
    if (mLoopBack) {
      mLoopBack->InitPlaybackSource(device, static_cast<float>(volume / 100.0), [&](std::shared_ptr<float[]>& data, int sampleRate, int channel)->void {
        std::shared_ptr<vhall::AudioCaptureMix> mix = mMix;
        if (mix) {
          std::chrono::time_point<std::chrono::steady_clock> ts = std::chrono::steady_clock::now();
          int64_t curTime = std::chrono::duration_cast<std::chrono::microseconds>(ts.time_since_epoch()).count();
  ...
  int32_t webrtc::VHAudioDeviceWindowsCore::StopLoopBack() {
    if (mLoopBack) {
      mLoopBack->Stop();
      mLoopBack.reset();
    }
  ...
  void webrtc::VHAudioDeviceWindowsCore::SetLoopBackVolume(uint32_t volume) {
    std::shared_ptr<vhall::AudioLoopBackRecording> loopBack = mLoopBack;
    if (loopBack) {
      loopBack->SetVolume(static_cast<float>(volume / 100.0f));
      loopBack.reset();
    }
  }
  int32_t webrtc::VHAudioDeviceWindowsCore::RegisterAudioCaptureObserver(webrtc::AudioTransport* audio_observer) {
    this->audio_observer = audio_observer;
    return 0;
  }
}  // namespace webrtc